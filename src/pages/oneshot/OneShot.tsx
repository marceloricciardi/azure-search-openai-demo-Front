    ...
    return (
        <div className={styles.oneshotContainer}>
            <div className={styles.oneshotTopSection}>
                ...
                <h1 className={styles.oneshotTitle}>Tire uma dúvida</h1>
                <div className={styles.oneshotQuestionInput}>
                    <QuestionInput
                        placeholder="Exemplo: Meu plano de saúde cobre custos de exame de vista?"
                        disabled={isLoading}
            ...
            >
                ...
                <SpinButton
                    className={styles.oneshotSettingsSeparator}
                    label="Recupere esses documentos da busca:"
                    min={1}
                    max={50}
